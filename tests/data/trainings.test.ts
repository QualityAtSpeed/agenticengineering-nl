...
describe('trainings catalogue', () => {
  it('Basic is a 2-day training with 23 modules split 11 / 12 across two days', () => {
    ...
    expect(basic.modules.filter((m) => m.day === 2)).toHaveLength(12);
  });
  ...
  it('discount-aug-26 is the Basic curriculum as a dated cohort with a 30% early-bird until 15 Sep', () => {
    ...
    expect(discountAug26.earlyBird).toEqual({
      discountPct: 30,
      deadline: '2026-09-15T00:00:00+02:00',
    });
